...
save_relaxation_panel_pdf(r, resvec_inner, svd_ratios, singular_values, outer_tol, size(B), cond_B; cg_method = "Krylov_cg", outfile="QR_comparison_rank_$(r)_fixed_outertol_$(outer_tol)_different_innertol_")
...
save_rank_panel_pdf(r, resvec_inner, svd_ratios, singular_values, size(B), cond_B; cg_method = cg_method = "Krylov_cg", outfile="$(outertolstr)/QR_rank_$(r)_fixed_outertol_$(outer_tol)_different_innertol")
#----------------------------------------------------------------------------------------------------------------#
...
#     # Plot each case separately (fixed outertol and different innertol)
#     outertolstr = @sprintf("outertol_%1.0e", outer_tol)
#     save_rank_panel_pdf(r, resvec_inner, svd_ratios, singular_values, size(B), cond_B; cg_method = "Krylov_cg", outfile="$(outertolstr)/QR_rank_$(r)_fixed_outertol_$(outer_tol)_different_innertol_")
# end

# # Plot exact results for outer_tol = inner_tol
# save_rank_panel_pdf(r, resvec, svd_ratios, singular_values, size(B), cond_B; cg_method = "Krylov_cg", outfile="QR_exact")
#----------------------------------------------------------------------------------------------------------------#
